...
#-------------------------------------------------------------------------------
### Cleaning & Combining Data Frames
  # Combine data frames
  ...
  # Fill missing values by averaging the neighbours
  ...
  # Fill missing values through linear regression using the surrounding rows with values
    for(vol in 1:35) {
      pos = 1424
      pos = pos + vol
...
### Export data frame to .csv
  write.csv(btc_total,"C:/Users/Kevin/Desktop/btc_total.csv", row.names = TRUE)
